...
module.exports = function (ctx) {
  ...
  // ---------- Suche ----------
  {
    const body = html`<div class="container page" data-search-page>
      ...
      <aside>${c.sideCard('Häufig gesucht', html`<div class="chips">${['dax', 'gold', 'bitcoin', 'eur-usd', 'brent', 'silber', 'bund-10j', 'uran'].map(s => { const i = instruments.bySlug[s]; return html`<a class="chip" href="${c.url(i)}">${i.name}</a>`; })}<a class="chip" href="/wissen/boersenlexikon">Börsenlexikon</a><a class="chip" href="/termine/wirtschaftskalender">Wirtschaftskalender</a></div>`)}${c.sideKnowledge()}</aside></div></div>`;
