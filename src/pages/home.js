...
module.exports = function (ctx) {
  ...
  const featuredPost = content.blog.posts.find(p => p.featured) || null;
  const homePosts = posts.filter(p => p !== featuredPost).slice(0, 18); // Startseite: höchstens 18 Beiträge (3 Seiten à 6); das Archiv liegt unter /blog
