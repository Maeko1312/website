...
module.exports = function (ctx) {
  ...
  const nlForm = ({ id, button = 'Kostenlos anmelden', cls = 'btn-teal', compactRow = false, fine = true }) => html`<form class="newsletter" data-newsletter ${ctx.layout.formAttrs()} novalidate>
    ...
    <label class="check"><input type="checkbox" name="consent" required> Ich möchte den Newsletter erhalten und akzeptiere die <a href="/datenschutz">Datenschutzhinweise</a>. Abmeldung jederzeit mit einem Klick.</label>
